...
function DismissOpportunityDialog({ reason, onReasonChange, onCancel, onConfirm }) {
  return (
    <div className="fixed inset-0 z-50 flex items-end bg-black/35 px-4 py-6">
      <section className="mx-auto w-full max-w-md rounded-[30px] bg-app-white p-5 shadow-card">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h2 className="text-2xl font-extrabold text-app-ink">关闭服务机会</h2>
            <p className="mt-2 text-base leading-7 text-app-muted">
              系统生成的服务提醒可能不完全符合实际，如确认暂不采纳，请选择原因。
            </p>
          </div>
          <button
            type="button"
...
export default DismissOpportunityDialog;
